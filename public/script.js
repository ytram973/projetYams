...
let pastryCount = 0; // Compteur de pâtisseries gagnées
...
btnLancer.addEventListener("click", () => {
  ...
  if (isYams(results)) {
    ...
    confettiAnimation();
    pastryCount++; // Incrémenter le compteur de pâtisseries gagnées
  ...
  document.querySelector(".patisserieWin").textContent = `Pâtisserie gagnée : ${pastry}`;
  document.querySelector(".nombreWin").textContent = `Nombre de Pâtisseries gagnées : ${pastryCount}`;
